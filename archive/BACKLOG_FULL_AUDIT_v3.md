# Bandit Buddy — Full Backlog Audit Export v3

**Repository:** https://github.com/flappybirdweb3/bandit-buddy
**Total Issues:** 59  
**Export date:** 2026-09-10  
**Audit Score:** 95/100 (v2 — sẵn sàng thực thi)

---

## Audit Changelog

| Round | Score | Thay đổi |
|-------|-------|---------|
| Audit v1 | 85/100 | Thêm 5 issues mới (#36–#38 Sprint 2, #48–#49 Sprint 3) |
| Audit v2 | 95/100 | Update 4 issues hiện có: #46 #49 #50 #51 (GuildStaking.sol + $FARM routing) |

**Badges:**  
- ⭐ AUDIT FIX v1 = issue được thêm mới do audit v1 phát hiện thiếu
- 🔧 AUDIT FIX v2 = issue được cập nhật do audit v2 phát hiện cross-module mismatch
...
## Issue #39: [SC] BanditMarket.sol — P2P NFT Marketplace with EIP-712 order book
...
contract BanditMarket {
    ...
    function buyWithSignature(Order calldata order, bytes calldata signature) external payable {
        // 1. Verify deadline
        // 2. Verify EIP-712 signature vs seller
        // 3. Verify msg.value == order.price
        // 4. Invalidate nonce
        // 5. Transfer NFT seller -> buyer
        // 6. 97.5% to seller, 2.5% to TreasuryBuyBack
    }
...
## Issue #40: [SC] BanditDogFusion.sol — Guard Dog Gacha with Commit-Reveal Oracle RNG
...
## Pity: guaranteed Rare at 90 pulls, Legendary at 300 pulls

## Acceptance Criteria
- [ ] Commit-reveal prevents miner manipulation
- [ ] Pity counter on-chain per address
- [ ] Burn 3 NFTs + 1000 $FARM -> upgrade attempt
- [ ] 100% Hardhat test coverage
...
## Issue #59: Admin dashboard — farm stats, user management, economy monitoring
